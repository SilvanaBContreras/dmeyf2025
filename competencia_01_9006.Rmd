...
HT 
dataset: fe1yag (lags delta 1, aguinaldo, payroll normalizado)
equivale a fe1 (porque aguinaldo y payroll son sobre 202106)
...
dataset <- fread("C:/Users/Silvana/Documents/Maestria Exactas/DMEyF/competencia 1/competencia_01_fe1yag.csv.gz", stringsAsFactors= TRUE)

# dataset <- fread("/content/buckets/b1/datasets/competencia_01_fe.csv.gz", stringsAsFactors= TRUE)

#Rstudio VM
# dataset <- fread("~/datasets/competencia_01_fe1yag.csv.gz", stringsAsFactors= TRUE)
