...
9011. test mejor modelo plus agui

HT (9002)
dataset: fe (lags delta 1,2,3)
11 hiperparámetros
train 1,2,3
0.2
auc 0.9441
...
final train 1, 2, 3
dataset: fe (lags delta 1,2,3 plus agui)
5 semillas
...
# dataset <- fread("~/datasets/competencia_01_fe.csv.gz", stringsAsFactors= TRUE)
