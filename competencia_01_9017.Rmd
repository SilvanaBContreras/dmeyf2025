...
HT 
dataset: fe123rank_short 
11 hiperparámetros 
train 1,2,3
0.2
AUC = stop#36. auc = 0.9447


final train 1, 2, 3
dataset:  fe123ranshort. mpayroll 202106 reemplazado por normalizado (-aquinaldo estimado)
5 semillas
...
fwrite(dataset,
       file = "competencia_01_fe123_rankshort_agui.csv.gz",
       sep = ",")
