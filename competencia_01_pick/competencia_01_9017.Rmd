...
HT 
dataset: fe123rank_short (lags y deltas hasta orden 3, rankings en variables monetarias del top20 de feature importance)
11 hiperparámetros 
train 202101, 202102, 202103
undersampling: 0.2
AUC = 0.9447 (viene de exp 9012)


final train 202101, 202102, 202103
dataset:  fe123ranshort. (lags y deltas hasta orden 3, rankings en variables monetarias del top20 de feature importance) Además, mpayroll 202106 en empleados con aguinaldo detectado fue reemplazado por su estimación (mpayroll - mpayrolldelta1 + 0,32 inflacion)

predicción promedio de 5 semillas

future 06
false future )test) 04
...
if(length(variables_faltantes) > 0) {
  cat("\nVariables no encontradas en dataset:\n")
...
# vars_ranking <- variables_continuas  # CON TODAS LAS MONETARIAS
...
##fwrite competencia_01_fe123_rankshort


```{r}
# setwd(dir_experimento)

fwrite(dataset, file = "competencia01_fe123_rankshort.csv.gz", sep = ",")
...
### levanto fe123_Rankshort
```{r}

# getwd()
dataset <- fread("competencia01_fe123_rankshort.csv.gz", stringsAsFactors = TRUE)
...
# toma resultado iteración #36. 
# replicado en este notebook, generado en EXP 9012 
# AUC= 0,9447
