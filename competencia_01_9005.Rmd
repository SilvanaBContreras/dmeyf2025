...
resumen:
HT 9002: auc 0.9441; fe lags deltas 1,2,3; 1,2,3; 0.2 - final: 1,2,3,4; fe lags deltas 1; 7 seeds
...
PARAM$train_final <- c(202102, 202101, 202103, 202104)
...
```
```{r}
cat("=== VERIFICACIÓN CRÍTICA dtrain_final ===\n\n")
