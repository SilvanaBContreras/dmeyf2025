...
HT 9002 AUC 0.945 
HT dataset: fe lags deltas 1,2,3
...
dataset <- fread("C:/Users/Silvana/Documents/Maestria Exactas/DMEyF/competencia 1/datos/competencia_01_crudo.csv" )
...
dataset <- fread("C:/Users/Silvana/Documents/Maestria Exactas/DMEyF/competencia 1/datos/competencia_01.csv.gz", stringsAsFactors= TRUE) #este tiene clase ternaria y lee factores
# # dataset <- fread("/content/datasets/competencia_01.csv.gz") #este tiene clase ternaria
# dataset <- fread("C:/Users/Silvana/Documents/Maestria Exactas/DMEyF/competencia 1/datos/competencia_01.csv.gz") #este tiene clase ternaria
```
...
```{r chunk31}
PARAM <- list()
PARAM$experimento <- 9004

PARAM$semilla_primigenia <- 999199
PARAM$semillas <- c(999199, 999499
, 999599, 999959, 999979, 104729, 523987, 7919,1299709, 2097593
)
...
dataset <- fread("C:/Users/Silvana/Documents/Maestria Exactas/DMEyF/competencia 1/resultados/datasets/competencia_01_fe.csv.gz", stringsAsFactors= TRUE)
...
p <- ggplot(tb_importancia_top, aes(x = reorder(Feature, Gain), y = Gain)) +
  ...
  labs(
    title = paste0("Top 20 Feature Importance - Experimento ", PARAM$experimento),
...
ggsave("feature_importance_ggplot.png", p, width = 12, height = 8, dpi = 300)
```

```{r chunk84}
# Gráfico nativo de lightgbm
png("feature_importance_lgb.png", width = 800, height = 600)
...
# Crear directorio kaggle dentro del experimento
...
nombre_grafico <- paste0("curva_ganancia_exp_", PARAM$experimento, ".png")
ggsave(nombre_grafico, p, width = 10, height = 6, dpi = 300)
