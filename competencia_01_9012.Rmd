...
##Levanto competencia_01_fe123_rankshort
```{r}
...
# 3. Los demás quedan en NA (no hacer nada, ya están en NA)

```

```{r}
# Contar únicos y registros por mes
dataset[, .(
...
## fwrite competencia_01_fe123_rankshort_agui06
...
fwrite(dataset,
       file = "competencia_01_fe123_rankshort_agui06.csv.gz",
       sep = ",")
...
```{r chunk38}
# EXP NUEVOS BORDES a ESPERIMENTAR
# 
# PARAM$hyperparametertuning$hs <- makeParamSet(
#   makeIntegerParam("num_iterations", lower= 500L, upper= 3000L), #acorté
#   # o más con early stopping al entrenar
#   makeNumericParam("learning_rate", lower= 0.005, upper= 0.2), #agrandé
#   makeNumericParam("feature_fraction", lower= 0.2, upper= 0.99),
#   makeIntegerParam("num_leaves", lower= 64L, upper= 1000L),
